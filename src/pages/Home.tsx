      ...
      <div className="relative overflow-hidden">
        ...
        <main className="px-4 py-6 max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-3 overflow-x-auto scrollbar-hide scroll-smooth-touch touch-pan-x overscroll-x-contain pb-2 -mx-4 px-4 md:mx-0 md:px-0 md:grid md:grid-cols-3 lg:grid-cols-5 md:overflow-visible">
              <TooltipProvider>
                  ...
                  <Tooltip key={subject.name}>
                    <TooltipTrigger asChild>
                      <Link 
                        ...
                        className={`flex-shrink-0 w-[100px] md:w-auto bg-card/60 rounded-xl p-3 flex flex-col items-center gap-2 active:scale-[0.97] transition-all duration-200 border-2 ${getBorderColor(subject.color)} hover:shadow-md`}
                      >
